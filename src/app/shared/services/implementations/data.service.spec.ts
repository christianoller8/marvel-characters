...
describe("DataService", () => {
  ...
  it("api return something", (done: DoneFn) => {
    const mockResult = {
      code: 200,
      status: "Ok",
      ...
      etag: "79eb32ac1892706fb8ec695cf7c26507c31c9674",
      data: {
        offset: 0,
        limit: 1,
        total: 54659,
        ...
        results: [
          {
            ...
            urls: [
              {
                type: "detail",
                url: "http://marvel.com/comics/issue/82967/marvel_previews_2017?utm_campaign=apiRef&utm_source=ebe435710d107a3a1fc3115018320a9c",
              },
            ],
            series: {
    ...
    service.getComics(1,0).subscribe((res) => {
